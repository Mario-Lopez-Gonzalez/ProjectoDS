 ...
 **/
/*void display_play_button_release(int index, int x, int y) { 
	oamSet(&oamMain, 	//main graphics engine context
		...
		gfx_play_button_release,		//+16*16/2, 	//pointer to the loaded graphics
...
*/
/*void remove_play_button_release(int index, int x, int y) {
	oamSet(&oamMain, 	//main graphics engine context
		index,  		//oam index (0 to 127)  
		x, y,    		//x and y pixel location of the sprite
		0,       		//priority, lower renders last (on top)
